...
namespace Hogskolan_Sarob
{
    ...
    class Studerande_klass: IStudenter
    {
        ...
        public Studerande_klass(int v1studentID, TextBox studentNamntextbox, long v2personnummer, TextBox emailtextbox, int v3telefonnummer)
        {
