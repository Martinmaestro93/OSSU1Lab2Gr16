...
{
    public partial class Studerande : Form
    {
       
        BindingList<Studerande_klass> studentInfo;
        ...
        /// </summary>
        private static Studerande m_SChildform;
        public static Studerande GetChildInstance4()
        {
            if (m_SChildform == null) //if not created yet, Create an instance

                m_SChildform = new Studerande();
        ...
        private void InitializeListOfParts()
        {
            ...
            studentInfo = new BindingList<Studerande_klass>();
        ...
        {
            e.NewObject = new Studerande_klass(int.Parse(studenterstudentID.Text), studenterstudentNamn, long.Parse(studenterpersonnummer.Text),
        ...
        {
            Studerande_klass student = studentInfo.AddNew();
