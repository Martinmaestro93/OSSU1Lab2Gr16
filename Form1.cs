...
namespace Hogskolan_Sarob
{
    ...
    {
        public Form1() //Nathalie test v.
        {
            #region Box för lärarlag
            InitializeComponent();
        ...
        /// </summary>
        private static Form1 m_SChildform;
        public static Form1 GetChildInstance2()
        {
        ...
        BindingList<Lararlag> lararlagLista;
        private void InitializeListOfLararlag()
        {

            lararlagLista = new BindingList<Lararlag>();
            ...
            lararlagLista.Add(new Lararlag(1, 10));
            lararlagLista.Add(new Lararlag(1, 11));
        }

        // Metod där attribut läggs till
        void lararlagLista_AddingNew(object sender, AddingNewEventArgs e)
        {
            e.NewObject = new Lararlag(int.Parse(LararlagIDText.Text), int.Parse(PersonalIDText.Text));

        }

        private void buttonLäggTillLag_Click(object sender, EventArgs e)
        {
            Lararlag newPart = lararlagLista.AddNew();
